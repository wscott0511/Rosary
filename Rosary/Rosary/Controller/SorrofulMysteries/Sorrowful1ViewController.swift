//
//  Sorrowful1ViewController.swift
//  Rosary
//
...
class Sorrowful1ViewController: UIViewController {
...
// MARK: - Functions
    ...
    @IBAction func nextButton(_ sender: UIButton) {
        ...
        if prayerNumber + 1 < prayers.count {
            ...
            performSegue(withIdentifier: "Sorrowful1To2", sender: nil)
        }
    }
    
    @objc func updateUI() {
        prayerTitle.text = prayers[prayerNumber].title
        prayerLabel.text = prayers[prayerNumber].prayer
    }
